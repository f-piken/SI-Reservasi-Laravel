                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <a class="btn btn-primary" href="{{ route('customer.create') }}" role="button">Input</a>
                                <a href="{{ url('cusPdf') }}" class="btn btn-warning">Buat Laporan</a>
                            </div>
                            <div class="card-body">
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form action="{{ route('customer.destroy',$cus->ID_Customer) }}" method="POST">
                                                  @csrf
                                                  @method('delete')
                                                  <a href="{{ route('customer.edit',$cus->ID_Customer) }}" class="btn btn-success btn-sm">Edit</a>
