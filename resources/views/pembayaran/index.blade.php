                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <a class="btn btn-primary" href="{{ route('pembayaran.create') }}" role="button">Input</a>
                                <a href="{{ url('pemPdf') }}" class="btn btn-warning">Buat Laporan</a>
                            </div>
                            <div class="card-body">
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form action="{{ route('pembayaran.destroy',$cus->ID_Pembayaran) }}" method="POST">
                                                  @csrf
                                                  @method('delete')
                                                  <a href="{{ route('pembayaran.edit',$cus->ID_Pembayaran) }}" class="btn btn-success btn-sm">Edit</a>
