...
<body>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Buat Data Reservasi</strong>
                            </div>
                            <div class="card-body">
                                <form action="{{ route('reservasi.store') }}" method="post">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9">
                                            <select name="room" id="room" class="form-control" onchange="updateUserId()">
                                                ...
                                                @foreach ($room as $cus)
                                                    <option value="{{ $cus->ID_Room }}">{{ $cus->No_Room }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><input type="date" id="tgl" name="tgl" placeholder="Tanggal Reservasi" class="form-control"></div>
                                    </div>
    ...
    <script>
        ...
        var emailDropdown = document.getElementById('nama');
