                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <a class="btn btn-primary" href="{{ route('reservasi.create') }}" role="button">Input</a>
                                <a href="{{ url('resPdf') }}" class="btn btn-warning">Buat Laporan</a>
                            </div>
                            <div class="card-body">
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $cus->room->No_Room }}</td>
                                            <td>{{ $cus->Tanggal_Reservasi }}</td>
                                            <td>{{ $cus->Waktu_Reservasi }}</td>
                                            <td>
                                                <form action="{{ route('reservasi.destroy',$cus->ID_Reservasi) }}" method="POST">
                                                  @csrf
                                                  @method('delete')
                                                  <a href="{{ route('reservasi.edit',$cus->ID_Reservasi) }}" class="btn btn-success btn-sm">Edit</a>
