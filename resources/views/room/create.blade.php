                            ...
                            <div class="card-body">
                                <form action="{{ route('room.store') }}" method="post">
                                    ...
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="room" class="form-control-label">Nomor Room</label></div>
                                        <div class="col-12 col-md-9"><input type="number" id="room" name="room" placeholder="Nomor Room" class="form-control"></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="tipe" class="form-control-label">Tipe Room</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="tipe" name="tipe" placeholder="Tipe Room" class="form-control"></div>
                                    </div>
                                    <div class="row form-group">
