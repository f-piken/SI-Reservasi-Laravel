                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <a class="btn btn-primary" href="{{ route('room.create') }}" role="button">Input</a>
                                ...
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form action="{{ route('room.destroy',$cus->ID_Room) }}" method="POST">
                                                  @csrf
                                                  @method('delete')
                                                  <a href="{{ route('room.edit',$cus->ID_Room) }}" class="btn btn-success btn-sm">Edit</a>
