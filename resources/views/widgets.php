...
<head>
    ...
    <link rel="stylesheet" href="style/assets/vendors/bootstrap/dist/css/bootstrap.min.css">
    <link rel="stylesheet" href="style/assets/vendors/font-awesome/css/font-awesome.min.css">
    <link rel="stylesheet" href="style/assets/vendors/themify-icons/css/themify-icons.css">
    <link rel="stylesheet" href="style/assets/vendors/flag-icon-css/css/flag-icon.min.css">
    <link rel="stylesheet" href="style/assets/vendors/selectFX/css/cs-skin-elastic.css">
...
<body>
        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    <li>
                        <a href="dashboard.blade.php"> <i class="menu-icon fa fa-dashboard"></i>Dashboard </a>
                    </li>
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="menu-icon fa fa-sign-in"></i><a href="login.blade.php">Login</a></li>
                            <li><i class="menu-icon fa fa-sign-in"></i><a href="register.blade.php">Register</a></li>
                            <li><i class="menu-icon fa fa-paper-plane"></i><a href="forget.blade.php">Forget Pass</a></li>
                        </ul>
                    </li>
                </ul>
            </div><!-- /.navbar-collapse -->
    ...
    <script src="style/assets/vendors/jquery/dist/jquery.min.js"></script>
    <script src="style/assets/vendors/popper.js/dist/umd/popper.min.js"></script>
    <script src="style/assets/vendors/bootstrap/dist/js/bootstrap.min.js"></script>
    <script src="style/assets/assets/js/main.js"></script>

    <!--  Chart js -->
    <script src="style/assets/vendors/chart.js/dist/Chart.bundle.min.js"></script>
